...
$config['paths'] = array(
	 ...
	 */
	'libs' => array(
		'simplesamlphp' => '/Users/dopey/Projects/SURFnet/MediaWiki/Workspace/simplesaml',
	),
...
$config['internal'] = array(
	 ...
	 */
	'authMode' => 'lazy',
	'strictLogoutTarget' => 'https://www.surfconext.nl/logout.html',
...
$config['comm'] = array(
	...
	'onUserCreation' => array(
         ...
         * Notify the configured address about new automatically created aucounts 
	 	 ...
	 	 */
		'notifyMail' => false,
		'notifyMailTo' => 'surfconext@cozmanova.com',
		'notifyMailFrom' => 'noreply@mw-mailer',
...
$config['extra'] = array(
	/*
	 * Change the SpecialPage:UserLogin to be handled by 
	 * the MultiAuthSpecialLogin handler
	 * When true, it will completely eliminate local login 
	 */
	'rehookUserLogin' => true,
